...
export default function Example() {
  ...
  return (
    <div className="bg-white relative z-50">
              ...
              <div className="border-b border-gray-200">
                <TabList className="-mb-px flex space-x-8 px-4">
                  {navigation.categories.map((category) => (
                    <Tab
                      key={category.name}
                      className="flex-1 cursor-pointer border-b-2 border-transparent px-1 py-4 text-base font-medium whitespace-nowrap text-gray-900 data-selected:border-indigo-600 data-selected:text-indigo-600"
                    >
                      {category.name}
                    </Tab>
                  ))}
            ...
            <div className="flex h-16 items-center">
              ...
              {false? (
                <Menu as="div" className="relative inline-block text-left">
                  <div>
                    <MenuButton className="inline-flex  justify-center gap-x-1.5 rounded-full bg-blue-800 px-5 py-3 text-xl font-semibold text-white">
                      R
                    </MenuButton>
                  </div>
      ...
      <AuthModel signin={signin} handleClose={handleClose}/>
    </div>
  );
}
